...
@Injectable()
export class FrameworkContributerPolicyHandler implements PolicyHandler<FrameworkContributerPolicy> {
  ...
  async handler(policy: FrameworkContributerPolicy, user: UserEntity): Promise<void> {
